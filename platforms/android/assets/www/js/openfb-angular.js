...
angular.module('openfb', [])
    ...
    .factory('OpenFB', function ($rootScope, $q, $window, $http, $location, $state, AWSService) {
        ...
        function login(fbScope) {
            ...
            if (!oauthRedirectURL) {
                console.log('No explicit oauthRedirectURL');
                if (runningInCordova) {
                    ...
                    //console.log(document.location.origin + '/oauthcallback.html');
                    //oauthRedirectURL = document.location.origin + '/oauthcallback.html';
                    if (index > 0) {
        ...
        function oauthCallback(url) {
            ...
            if (url.indexOf("access_token=") > 0) {
                ...
                // Set access token for AWS
                AWSService.setToken(tokenStore['fbtoken']);
